...
const navItems = [
  ...
  { href: "/voice-agent", label: "Voice Agent", icon: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4M12 1a3 3 0 00-3 3v4a3 3 0 006 0V4a3 3 0 00-3-3z" },
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                isActive
                  ? "bg-primary-500/10 text-primary-400 glow-blue"
